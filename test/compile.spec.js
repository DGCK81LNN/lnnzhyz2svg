...
/** @typedef {import("../src/types").CompiledText} CompiledText */
  ...
  describe("shidinn", function () {
    describe("compileShidinn()", function () {
      ...
      it("handles vowelless characters correctly", function () {
        ...
        /** @type {CompiledText} */
        const expected =
          /* prettier-ignore */ [[{pre:[],main:{consonant:"v"},post:[{glide:"u"},{consonant:"p"}]}]]
        expect(result).to.deep.equal(expected)
      })
      ...
      it("should not treat i1, iE, u1, uA as valid finals", function () {
        ...
        const expected =
          /* prettier-ignore */
          [
            [{pre:[],main:{consonant:""},post:[{glide:"i"},{}]}],
            [{pre:[],main:{consonant:""},post:[{glide:"i"},{vowel:"ii"}]}],
            [{pre:[],main:{consonant:""},post:[{glide:"i",vowel:"uu"}]}],
            [{pre:[],main:{consonant:""},post:[{glide:"u"},{}]}],
            [{pre:[],main:{consonant:""},post:[{glide:"u",vowel:"ii"}]}],
            [{pre:[],main:{consonant:""},post:[{glide:"u"},{vowel:"uu"}]}]
          ]
        expect(result).to.deep.equal(expected)
      })
    })
